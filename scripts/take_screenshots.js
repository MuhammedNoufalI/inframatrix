...
(async () => {
    ...
    await page.waitForSelector('input[name="data.email"]', { timeout: 10000 });
    
    await page.type('input[name="data.email"]', 'admin@timesworld.com');
    await page.type('input[name="data.password"]', 'password');
    ...
    if (envTab.length > 0) {
        ...
        // Let's expand the first environment if possible to show integrations
